...
export const PlusSignIcon = (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M8 1.75a.75.75 0 0 1 .75.75v4.75h4.75a.75.75 0 0 1 0 1.5H8.75v4.75a.75.75 0 0 1-1.5 0V8.75H2.5a.75.75 0 0 1 0-1.5h4.75V2.5A.75.75 0 0 1 8 1.75" />
  </svg>
);
...
export const DownloadIcon = (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M0 0h48v48H0z"
      mask="url(#ipSDownloadThree0)"
    />
  </svg>
);


export const GitHubIcon = (<svg xmlns="http://www.w3.org/2000/svg" width={35} height={35} viewBox="0 0 24 24">
	<g fill="none">
		...
		<defs>
			<clipPath id="akarIconsGithubFill0">
				<path fill="#24913d" d="M0 0h24v24H0z"></path>
			</clipPath>
		</defs>
	</g>
</svg>);